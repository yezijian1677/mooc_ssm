...
<div class="container">
    ...
    <form class="form-horizontal" action="edit.do" method="post">
        <input class="id" name="id" type="hidden" value="${dept.id}">
        <input class="createTime" name="createTime" type="hidden" value="<fmt:formatDate value="${dept.createTime}" pattern="yyyy-MM-dd HH:mm"/>">
        ...
        <div class="form-group">
            ...
            <select id="categoryId" name="categoryId" class="col-sm-2 form-control" style="width: auto">
                <c:forEach items="${cates}" var="cate">
                    <c:if test="${cate.id == dept.categoryId}">
