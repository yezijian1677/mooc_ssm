...
<div class="gallery">
    ...
    <div  align="center">
        ...
        <tr>
            <td><a href="${pageContext.request.contextPath}/book/flist.do?page=1">first</a></td>
            <td><a href="${pageContext.request.contextPath}/book/flist.do?page=${page.nextPage}">next</a></td>
            <td><a href="${pageContext.request.contextPath}/book/flist.do?page=${page.prePage}">prex</a></td>
            <td><a href="${pageContext.request.contextPath}/book/flist.do?page=${page.lastPage}">last</a></td>
        </tr>
